...
class ClassroomsControllerTest < ActionController::TestCase
  ...
  test "should create classroom" do
    assert_difference('Classroom.count') do
      post :create, classroom: { building_id: @classroom.building_id, name: @classroom.name, occupancy: @classroom.occupancy }
    end
  ...
  test "should update classroom" do
    patch :update, id: @classroom, classroom: { building_id: @classroom.building_id, name: @classroom.name, occupancy: @classroom.occupancy }
    assert_redirected_to classroom_path(assigns(:classroom))
  end
